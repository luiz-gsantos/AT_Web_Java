...
public class StreetService {
	...
	public Collection<Street> obterListaOrdenadaPorAno(){
		return (Collection<Street>) streetRepository.findAll(Sort.by(Sort.Direction.ASC, "ano"));
	}
	public Collection<Street> obterListaOrdenadaPorAno(Usuario usuario){
		return (Collection<Street>) streetRepository.obterLista(usuario.getId(), Sort.by(Sort.Direction.ASC, "ano"));
	}
}