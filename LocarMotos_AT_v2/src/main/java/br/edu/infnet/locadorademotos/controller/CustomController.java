...
public class CustomController {
	...
	public String telaLista(Model model, @SessionAttribute("usuario") Usuario usuario) {
		model.addAttribute("customs", customService.obterListaOrdenadaPorAno());
	...
	public String incluir(Custom custom, @SessionAttribute("usuario") Usuario usuario) {
		...
		msg = "A moto do tipo Custom foi adicionada com sucesso!";
		return "redirect:/listacustom";
	}
	@GetMapping(value = "/custom/{id}/excluir")
	public String excluir(@PathVariable Integer id) {
		Custom custom = customService.obterPorId(id);
		customService.excluir(id);
		msg = "A moto do tipo Custom foi excluida com sucesso!";
		return "redirect:/listacustom";
	}
}